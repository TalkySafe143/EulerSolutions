...
from one import one as problem_1
from two import two as problem_2
from three import three as problem_3
from four import four as problem_4
from five import five as problem_5
